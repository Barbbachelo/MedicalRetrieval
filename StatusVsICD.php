...
function StatusVsICDBar($ICD)
{

	/* Create and populate the pData object */
	$MyData = new pData(); 
	$connection = mysqli_connect("127.0.0.1", "root", "", "medicalretrieval");
	$searchQuery = "Select Status from patients where ICD = '$ICD'";
	...
	$MyData->addPoints($Status,"Status");
	$MyData->setSerieDescription("Status", "Status");
	$MyData->setAbscissa("Status");
	$MyData->setAbscissaName("Status");
...
/* Create and populate the pData object */
  ...
  $MyData->addPoints($count,"Number of Patients"); 
  $MyData->setSerieDescription("Number of Patients","Status");
...
$myPicture->drawText(10,13,"Patient Status with '$ICD'",array("R"=>255,"G"=>255,"B"=>255));
